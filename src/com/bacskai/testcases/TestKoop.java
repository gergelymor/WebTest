...
public class TestKoop extends QuickSearchCommon{
	
	private final String href = "koop";
	...
	private By fromPriceValue = By.id("range-filter-selector-select-filter_koopprijsvan");
	private By toPriceValue = By.id("range-filter-selector-select-filter_koopprijstot");
	...
	public TestKoop(WebDriver sharedDriver){
		super(sharedDriver);
	}
	...
	public void verifyElementsInitialPresence(){
		...
		Assert.assertTrue(sharedDriver.findElements(lastQuery).size() == 0);
	}
